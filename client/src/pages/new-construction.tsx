...
import newConstructionHeroImage from "@/assets/images/north-texas.jpg";
            ...
            <div className="bg-white shadow-lg overflow-hidden max-w-4xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-4 lg:p-6 bg-slate-100">
                  ...
                  <div className="text-slate-600 leading-relaxed mb-6">
                    <p>
                      New homes are built to current energy codes with advanced insulation, efficient HVAC systems, 
                      and energy-star appliances. This means lower monthly utility bills and a smaller environmental 
                      footprint from day one, saving you thousands over the years.
                    </p>
                  </div>
