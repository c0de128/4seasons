          ...
          <div className="mb-16">
            ...
            <div className="space-y-4">
              <p className="text-lg text-slate-600 text-left">
                ...
                Building a solid financial foundation is crucial before making your home purchase.
              </p>
              <p className="text-lg text-slate-600 text-left">
                Our calculator helps you plan for the complete cost of homeownership - not just the down payment,
                but also closing costs, moving expenses, and an emergency fund. We recommend saving 25-30% of your
                target home price to ensure you're financially prepared for all aspects of buying and owning a home.
              </p>
              <p className="text-lg text-slate-600 text-left">
                Use this tool to experiment with different savings amounts and timelines. Small increases in your
                monthly savings can dramatically reduce the time to reach your goal. Start building your homeownership
                dreams today with a clear, achievable savings plan.
              </p>
            </div>
          </div>
