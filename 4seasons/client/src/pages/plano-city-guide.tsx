...
export default function PlanoCityGuide() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Plano Texas Real Estate & City Guide | 4Seasons Real Estate"
        description="Discover Plano, Texas - home to Fortune 500 companies, top-rated schools, and premier neighborhoods. Find homes for sale in Plano with local real estate experts."
        keywords="Plano Texas real estate, Plano homes for sale, Plano ISD schools, Plano neighborhoods, Legacy West, North Texas real estate, Plano city guide"
        canonical={`${seoConfig.siteUrl}/plano-city-guide`}
        openGraph={{
          title: "Plano Texas Real Estate & City Guide | 4Seasons Real Estate",
          description: "Explore Plano, Texas - premier North Texas community with Fortune 500 corporate headquarters, world-class schools, and luxury neighborhoods.",
          images: [{
            url: `${seoConfig.siteUrl}/assets/images/plano-og.jpg`,
            width: 1200,
            height: 630,
            alt: "Plano Texas skyline and neighborhoods"
          }]
        }}
        structuredData={[
          generateStructuredData.cityGuideWithRealEstate({
            name: "Plano",
            state: "Texas",
            population: "285,494",
            ...
            schoolRating: "A+",
            description: "Plano is a premier North Texas city known for Fortune 500 corporate headquarters, exceptional schools, and high quality of life."
          }),
          generateStructuredData.localBusiness({
            name: "4Seasons Real Estate - Plano",
            address: "123 Legacy Dr, Plano, TX 75023",
            phone: "(972) 555-0123",
            areaServed: "Plano, Texas"
          }),
          generateStructuredData.faqPage([
            {
              question: "What is the average home price in Plano, Texas?",
              answer: "The median home price in Plano is approximately $525,000, with neighborhoods ranging from $350K to over $1.2M depending on location and amenities."
            },
            {
              question: "How are the schools in Plano?",
              answer: "Plano is served by two A+ rated school districts - Plano ISD and Frisco ISD - both nationally recognized for academic excellence and innovative programs."
            },
            {
              question: "What major companies are headquartered in Plano?",
              answer: "Plano is home to Fortune 500 companies including Toyota North America, Liberty Mutual, J.C. Penney, and many other major corporations."
            }
          ])
        ]}
      />
      <SEOBreadcrumb
        items={[
          { name: "Home", href: "/" },
          { name: "City Guides", href: "/city-guides" },
          { name: "Plano City Guide", href: "/plano-city-guide" }
        ]}
      />
      <Navigation />
