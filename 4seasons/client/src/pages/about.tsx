...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <SEO
        title="About 4Seasons Real Estate - Dallas-Fort Worth Real Estate Experts Since 2009"
        description="Meet Amy and Tim Harwood, your trusted North Texas real estate team. 15+ years experience, 500+ homes sold, 98% client satisfaction in Allen, Plano, Frisco and surrounding areas."
        keywords="Dallas Fort Worth real estate team, Allen TX real estate agents, North Texas property experts, Amy Harwood realtor, Tim Harwood real estate, Plano real estate broker, Frisco real estate specialist"
        canonical={`${seoConfig.siteUrl}/about`}
        openGraph={{
          title: "About 4Seasons Real Estate - Trusted North Texas Real Estate Team",
          description: "Meet Amy and Tim Harwood, your dedicated North Texas real estate experts with 15+ years experience and proven track record of success in Allen, Plano, and surrounding communities.",
          images: [{
            url: `${seoConfig.siteUrl}/assets/images/about-team-og.jpg`,
            width: 1200,
            height: 630,
            alt: "4Seasons Real Estate team - Amy and Tim Harwood"
          }]
        }}
        structuredData={[
          generateStructuredData.organization({
            name: "4Seasons Real Estate",
            description: "Premier North Texas real estate brokerage specializing in residential sales, property management, and investment services since 2009.",
            address: "123 Main Street, Allen, TX 75013",
            phone: "(972) 555-0123",
            email: "info@4seasonsrealestate.com",
            foundingDate: "2009",
            areaServed: ["Allen", "Plano", "Frisco", "McKinney", "Richardson", "North Texas"]
          }),
          generateStructuredData.person({
            name: "Amy Harwood",
            jobTitle: "Real Estate Broker & Agency Owner",
            description: "Seasoned Real Estate Broker with 15+ years experience in North Texas residential market, specializing in buying, selling, and market analysis.",
            email: "amy@4seasonsrealestate.com",
            knowsAbout: ["Real Estate", "Property Management", "North Texas Markets", "Residential Sales"],
            worksFor: "4Seasons Real Estate"
          }),
          generateStructuredData.person({
            name: "Tim Harwood",
            jobTitle: "Finance and Property Management Professional",
            description: "Experienced underwriter and property management professional with 20+ years in real estate and finance, specializing in mortgage lending and property management.",
            email: "tim@4seasonsrealestate.com",
            knowsAbout: ["Mortgage Underwriting", "Property Management", "Real Estate Finance", "Investment Properties"],
            worksFor: "4Seasons Real Estate"
          }),
          generateStructuredData.faqPage([
            {
              question: "How long has 4Seasons Real Estate been in business?",
              answer: "4Seasons Real Estate was founded in 2009 and has been serving North Texas communities for over 15 years, building a reputation for exceptional service and market expertise."
            },
            {
              question: "What areas does 4Seasons Real Estate serve?",
              answer: "We specialize in North Texas communities including Allen, Plano, Frisco, McKinney, Richardson, and surrounding areas. Our deep local knowledge helps clients make informed decisions."
            },
            {
              question: "What services does 4Seasons Real Estate offer?",
              answer: "We offer comprehensive real estate services including residential buying and selling, property management, market analysis, investment property guidance, first-time buyer programs, and relocation assistance."
            },
            {
              question: "What is the team's track record?",
              answer: "Our team has sold 500+ homes with a 98% client satisfaction rate. We combine 15+ years of market experience with innovative marketing strategies and personalized service."
            }
          ])
        ]}
      />
