...
import homeAffordabilityHeroImage from "@/assets/images/hero-images/7572.jpg";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${homeAffordabilityHeroImage})`,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.7)' }}>
              How Much House
              <span className="text-yellow-400 block" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.7)' }}>Can You Afford?</span>
            </h1>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-4">
              <p className="text-lg text-slate-600 text-left">
                ...
                Understanding what you can afford is the crucial first step in your home buying journey.
              </p>
              <p className="text-lg text-slate-600 text-left">
                Our calculator uses industry-standard debt-to-income ratios and takes into account your income,
                existing debts, down payment, and local North Texas property costs including taxes and insurance.
                Get a realistic view of your purchasing power and start house hunting with confidence.
              </p>
              <p className="text-lg text-slate-600 text-left">
                Remember, just because you qualify for a certain amount doesn't mean you should spend it all.
                Leave room in your budget for unexpected expenses, future goals, and peace of mind.
              </p>
            </div>
          </div>
